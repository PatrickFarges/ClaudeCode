...
- **`craft_registry.gd`** : ~69 recettes, 6 catégories (Hand, Furnace, Wood/Stone/Iron/Gold Table). **Forge** : 3 recettes `_tool_tier` (bois/pierre/fer). **Torche** : 1 coal + 1 planks → 4 torches. **Armes** : Épée fer, Épée or, Bouclier. **Coffre** : 8 planches → 1 CHEST (wood_table)
