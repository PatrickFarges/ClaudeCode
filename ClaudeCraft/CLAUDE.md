...
| - | v21.6.0 | **Fix bucket + animations mobs** : bucket raywalk (eau sans collision → scan voxels), entity defs versionnées (horse_v3 etc.), guess_anim/ctrl amélioré (animation.common.look_at_target), clamp universel poids [0,1] dans BedrockAnimPlayer (fix llama+cow désarticulés) |
