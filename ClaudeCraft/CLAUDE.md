...
- **`village_inventory_ui.gd`** : UI gestion village (F1) — panel 700×900, phase, tier, **population X/Y**, **barre de faim** par villageois, **section fermes**, **bâtiments (X/Y)** avec progression en construction (blocs posés) et matériaux manquants pour le prochain, **prochain objectif + statut mine**, ressources, **villageois numérotés** (Mineur 1, Mineur 2...) avec **activité temps réel**, **clic = téléport joueur**
