...
- **`day_night_cycle.gd`** : cycle jour/nuit 600s, **vitesse du temps** 4 niveaux (Lent ×0.5 / Normal ×1 / Rapide ×2 / Très rapide ×10), glissière HUD + raccourcis `[` / `]`
